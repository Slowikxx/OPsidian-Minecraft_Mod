...
public enum ModArmorMaterial implements ArmorMaterial {
    OBSIDIAN("obsidian", 25, new int[] {4,9,7,4}, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3f, 0.2f, () -> Ingredient.ofItems(ModItems.OBSIDIAN_INGOT));
    ...
    public String getName() {
        return OPsidian.MOD_ID + ":" + this.name;
    }
